...
<div class="footer">
    <div class="wrap">
        ...
        <div class="box1">
            ...
            <ul class="social">
                <li><img src="${pageContext.request.contextPath}/resources/images/facebook.png" title="facebook"><a href="#">Facebook</a></li>
                <li><img src="${pageContext.request.contextPath}/resources/images/twitter.png" title="twitter"><a href="#">Twitter</a></li>
                <li><img src="${pageContext.request.contextPath}/resources/images/gplus.png" title="google+"><a href="#">Google+</a></li>
            </ul>
        </div>
        <div class="clear"> </div>
    </div>
