...
<div id="Wrapper">
    <div class="content">
        ...
        <div id="Main"  >
            <div class="sep20"></div>
            <div class="box">
                <div class="header"><a href="${pageContext.request.contextPath}/bbs">94lu社区</a> <span class="chevron">&nbsp;›&nbsp;</span> 我收藏的主题<div class="fr f12"><span class="snow">主题总数&nbsp;</span> <strong class="gray">${user_topical_count}</strong></div></div>
                <c:forEach items="${topics_list}" var="topical">
                ...
                <div class="inner">
                    <table cellpadding="0" cellspacing="0" border="0" width="100%">
                        <tbody><tr>
                            <td width="120" align="left"><c:if test="${pager.currentPage<=pager.pageCount&&pager.currentPage>1}"><input type="button" onclick="location.href ='${pageContext.request.contextPath}/bbs/topics?wpage=${pager.currentPage-1}';" value="‹ 上一页" class="super normal button"></c:if></td>
                            <td width="auto" align="center"><strong class="fade">${pager.currentPage}/${pager.pageCount}</strong></td>
                            <td width="120" align="right">    <c:if test="${pager.currentPage!=pager.pageCount}"> <input type="button" onclick="location.href ='${pageContext.request.contextPath}/bbs/topics?wpage=${pager.currentPage+1}';" value="下一页 ›" class="super normal button"> </c:if></td>
                        </tr>
                        </tbody></table>
                </div>
            </div>
