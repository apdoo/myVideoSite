...
<div id="Wrapper">
    <div class="content">
        ...
        <div id="Main"  >
            <div class="sep20"></div>
            <div class="box">
                <div class="header"><a href="${pageContext.request.contextPath}/bbs">94lu</a> <span class="chevron">&nbsp;›&nbsp;</span> 提示</div>
                <div class="cell"><span class="gray bigger">${msg}</span></div>
                <div class="inner">← <a href="#" onclick="history.go(-1) ;return false;">返回</a></div>
            </div>
        </div>
    </div>
    <div class="c"></div>
