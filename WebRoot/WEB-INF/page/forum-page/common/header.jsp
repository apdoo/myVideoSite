                ...
                <table cellpadding="0" cellspacing="0" border="0" width="100%">
                    <tbody><tr>
                        ...
                        <c:if test="${userinfo.id==null}">
                            <td width="570" align="right" style="padding-top: 2px;"><a href="${pageContext.request.contextPath}" class="top">视频站首页</a>&nbsp;&nbsp;&nbsp;<a href="${pageContext.request.contextPath}/bbs" class="top">社区首页</a>&nbsp;&nbsp;&nbsp;<a href="${pageContext.request.contextPath}/bbs/member/${userinfo.username}" class="top">${userinfo.username}</a>&nbsp;&nbsp;&nbsp;<a href="${pageContext.request.contextPath}/account" class="top">注册</a>&nbsp;&nbsp;&nbsp;<a href="${pageContext.request.contextPath}/account" class="top">登录</a></td>
                        </c:if>
                        <c:if test="${userinfo.id!=null}">
                            <td width="570" align="right" style="padding-top: 2px;"><a href="${pageContext.request.contextPath}" class="top">视频站首页</a>&nbsp;&nbsp;&nbsp;<a href="${pageContext.request.contextPath}/bbs" class="top">社区首页</a>&nbsp;&nbsp;&nbsp;<a href="${pageContext.request.contextPath}/bbs/member/${userinfo.username}" class="top">${userinfo.username}</a>&nbsp;&nbsp;&nbsp;<a href="${pageContext.request.contextPath}/bbs/settings" class="top">设置</a>&nbsp;&nbsp;&nbsp;<a href="${pageContext.request.contextPath}/user/loginout?from=bbs" onclick="if (confirm('确定要从 94lu 登出？')) { location.href= '${pageContext.request.contextPath}/bbs'; }" class="top">登出</a></td>
                        </c:if>
